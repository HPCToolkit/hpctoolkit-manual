...
\textbf{NOTE: This feature is in an experimental state. Many cases may not work as expected, crashes and corrupted performance data are likely. Use at your own risk.}
...
\begin{enumerate}
\item
Pythons older than 3.10 are not supported by \HPCToolkit{}.
...
\item
The application must be run with the same Python that was used to compile \HPCToolkit{}.
